	...
	<div class="cont-type1 bg-type2">
		<div class="container">
			...
			<div class="form-wrap form-type1">
				<form class="wpcf7"  id="isform" method="post" name="isform" action="action.html">
				<dl>
					<dt><strong class="dott">*</strong> 이름</dt>
					<dd><input type="text" name="ap_name" id="ap_name" value="홍**"/><span class="copy">필수입력 항목입니다.</span></dd>
				</dl>
				<dl>
					<dt><strong class="dott">*</strong> 생년월일</dt>
					...
					<option value=''>-년</optioon>
						...
						<option value='1964' selected>1964년</optioon>
						...
						<option value='09' selected>9월</optioon>
						...
						<option value='12' selected>12일</optioon>
				...
				<!-- <dl>
					<dt><strong>*</strong> 주민등록번호 13자리</dt>
					<dd><input type="text" name="ap_jumin1" id="ap_jumin1" style="width: 150px;height: 37px;" value="701111"/>-<input type="text" name="ap_jumin2" id="ap_jumin2" style="width: 150px;height: 37px;" value="2111111"/></dd>
				</dl> -->				
				<dl>
					<dt><strong class="dott">*</strong> 성별</dt>
				...
				<dl>
					<dt><strong class="dott">*</strong> 휴대폰번호</dt>
					<dd><input type="text" name="ap_hp1" id="ap_hp1" style="width: 80px;height: 37px;" maxlength="3" value="010"/>-<input type="text" name="ap_hp2" id="ap_hp2" style="width: 80px;height: 37px;" maxlength="4" value="111"/>-<input type="text" name="ap_hp3" id="ap_hp3" style="width: 80px;height: 37px;" maxlength="4" value="1234"/>  <a class="btn btn-mini btn-centered btn-type1" style="width:100px;text-align:center" href="javascript:openkcb();"><span>실명확인</span></a> </dd>
				</dl>
				<dl>
					<dt><strong class="dott">&nbsp;</strong> 이메일주소</dt>
					<dd><input type="email" name="ap_email" id="ap_email" value="test@gmail.com" /></dd>
				</dl>
				<dl>
					<dt><strong>&nbsp;</strong> 거주지역</dt>
					<dd><select name="ap_local">
				...
				<dl>
					...
					<dd><select name="ap_job">
								<option value="0">선택</option>
								<option value="1" selected>근로소득자</option>
								<option value="2">개인사업자</option>
								<option value="3">법인사업자</option>
								<option value="4">기타소득자</option>
							</select>
					</dd>
				</dl>
				<dl>
					<dt><strong>&nbsp;</strong> 연소득</dt>
					<dd><input type="number" name="ap_income" value="500"/> 만원</dd>
				</dl>
				<dl>
					<dt><strong>&nbsp;</strong> 희망 대출액</dt>
					<dd><input type="number" name="ap_hope" value="1000"/> 만원</dd>
				</dl>
				<dl>
					...
					<dd><select name="ap_due">
							...
							<option value="34" selected>34개월</option>
							
							</select>
					</dd>
				</dl>
				<dl>
					<dt><strong>&nbsp;</strong> 자금용도</dt>
					<dd><select name="ap_rule">
							<option value="0">선택</option>
							<option value="1" selected>가계생활자금</option>
							<option value="2">금융기관상환자금</option>
							<option value="3">사업자금</option>
							<option value="4">예비자금</option>
							<option value="5">전세자금</option>
							<option value="6">주택자금</option>
							<option value="7">기타</option>
							</select>
					</dd>
				</dl>
				<dl>
					<dt><strong>&nbsp;</strong> 차량소유</dt>
					<dd><select name="ap_car">
							<option value="0">선택</option>
							<option value="1">1500cc</option>
							<option value="2" selected>2000cc</option>
							<option value="3">3000cc</option>
							<option value="4">3000cc초과</option>
    						<option value="5">없음</option>
							</select>
					</dd>
				</dl>
				<dl>
					<dt><strong>&nbsp;</strong> 보증재단 대출여부</dt>
					<dd>타 보증재단(햇살론, 근로자생계보증대출(지역신용보증재단), 미소금융, 캠코소액대출, 신용회복위원회, 신용회복기금, 한마음금융) 대출이 있습니까? 
					<BR><input type="radio" name="ap_rb" value="y">&nbsp;예&nbsp;&nbsp;&nbsp;<input type="radio" name="ap_rb" value="n" checked>&nbsp;아니오
					</dd>
				</dl>
				<dl>
					<dt><strong>&nbsp;</strong> 신용상태여부</dt>
					<dd>현재 고객님은 채무불이행(구 신용불량), 채무조정(신용회복, 개인회생) 상태입니까?  
					<BR><input type="radio" name="ap_rb1" value="y">&nbsp;예(신용불량)&nbsp;&nbsp;&nbsp;<input type="radio" name="ap_rb1" value="n" checked>&nbsp;아니오(정상)
					</dd>
				</dl>
				<dl>
					<dt><strong>&nbsp;</strong> 연체 여부</dt>
					<dd>현재 고객님은 연체 중 입니까?
					<BR><input type="radio" name="ap_rb2" value="y">&nbsp;예(연체중)&nbsp;&nbsp;&nbsp;<input type="radio" name="ap_rb2" value="n" checked>&nbsp;아니오(정상)
					</dd>
				</dl>				
				<dl>
					<dt class="new1"><strong>&nbsp;</strong> 금융회사 대출여부 </dt>
					<dd>
						<label style="width:25%;"><input type="checkbox" name="ap_card_1" value="y">카드론&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_card_2" value="1" placeholder="총건수">&nbsp;<input type="text"  class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_card_3" value="100" placeholder="총금액">만원
						<BR><label style="width:25%;"><input type="checkbox" name="ap_cash_1" value="y">현금서비스 리볼빙&nbsp;</label><input type="text" class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_cash_2" placeholder="총건수">&nbsp;<input type="text"  class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_cash_3" placeholder="총금액">만원
						<BR><label style="width:25%;"><input type="checkbox" name="ap_house_1" value="y">주택담보&nbsp;</label><input type="text" class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_house_2" placeholder="총건수">&nbsp;<input type="text"  class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_house_3" placeholder="총금액">만원
						<BR><label style="width:25%;"><input type="checkbox" name="ap_lent_1" value="y">전세자금&nbsp;</label><input type="text" class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_lent_2" placeholder="총건수">&nbsp;<input type="text"  class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_lent_3" placeholder="총금액">만원
						<BR><label style="width:25%;"><input type="checkbox" name="ap_credit_1" value="y">금융권 신용대출&nbsp;</label><input type="text" class="wpcf9-text" name="ap_credit_2" style="width: 9em;height: 37px;" placeholder="총건수">&nbsp;<input type="text"  class="wpcf9-text" name="ap_credit_3" style="width: 9em;height: 37px;" placeholder="총금액">만원
						<BR><label style="width:25%;"><input type="checkbox" name="ap_etc_1" value="y">저축은행 캐피탈등&nbsp;</label><input type="text" class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_etc_2" placeholder="총건수">&nbsp;<input type="text"  class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_etc_3" placeholder="총금액">만원
						<BR><label style="width:25%;"><input type="checkbox" name="ap_loan_1" value="y">대부업&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_loan_2" placeholder="총건수">&nbsp;<input type="text"  class="wpcf9-text" style="width: 9em;height: 37px;" name="ap_loan_3" placeholder="총금액">만원						
					</dd>					
				</dl>
				<div class="copy-box1">
					<ul class="list-type3">
					...
					<p class="copy2">
						...
						<div class = "check"><input type="checkbox" name="check_on" id="check_on1" class = "check" >서비스 이용약관에 동의합니다. [필수]</div><br>
						<div class = "check"><input type="checkbox" name="check_on" id="check_on1" class = "check" >개인 신용정보 제공에 동의합니다. [필수]</div><br>
						<div class = "check"><input type="checkbox" name="check_on" id="check_on1" class = "check" > 개인(신용)수집, 이용에 동의합니다. [필수]</div><br>
						<div class = "check"><input type="checkbox" name="check_on" id="check_on1" class = "check" >고유식별정도 처리방침에 동의합니다. [필수]</div><br>
						<div class = "check"><input type="checkbox" name="check_option" id="check_on1" class = "check" > 개인(신용)정보 선택적 수집, 이용 및 제공에 동의합니다. [선택]</div><br>
...
<script>
	...
	function mbsubmit(){
        ...
        if (document.isform.ap_name.value.length < 1) {
        ...
        }else if (document.isform.ap_job.value=="") {
            alert("직업구분을 입력하세요.");
            document.isform.ap_job.focus();
        }else if (document.isform.ap_income.value=="") {
            alert("희망대출액을 입력하세요.");
            document.isform.ap_income.focus();
        }else if (document.isform.ap_due.value=="") {
            alert("희망대출만기를 입력하세요.");
            document.isform.ap_due.focus();
        }else if (document.isform.ap_rule.value=="") {
            alert("자금용도를 선택세요.");
            document.isform.ap_rule.focus();
        }else if (document.isform.ap_car.value=="") {
            alert("차량소유를 선택세요.");
            document.isform.ap_car.focus();
            ...
            document.isform.ap_rb2.focus();
        }else if(eval(document.isform.ap_loan_2.value) >= 0 && document.isform.ap_cash_3.value.trim() != ""){
			alert("대부업 채무가 있으면 심사진행이 안됩니다.");
		}else if(eval(document.isform.ap_etc_2.value) >= 0 && document.isform.ap_etc_3.value.trim() != ""){
			alert("저축은행 캐피탈 채무가 있으면 심사진행이 안됩니다.");
		}else if((eval(document.isform.ap_cash_2.value) <= 0 || eval(document.isform.ap_cash_3.value) <= 0 || document.isform.ap_cash_2.value.trim() == "" || document.isform.ap_cash_3.value.trim() == "") && (eval(document.isform.ap_card_2.value) <= 0 || eval(document.isform.ap_card_3.value) <= 0 || document.isform.ap_card_2.value.trim() == "" || document.isform.ap_card_3.value.trim() == "")){
					alert("신용카드나 카드론 채무가 없으면 심사진행이 안됩니다.");
				...
				if(!document.isform.check_on1[i].checked){
					...
					case 3:
						...
						break;
					/*case 4:
						alert("개인(신용)정보 선택적 수집, 이용 및 제공에 동의하셔야 합니다. ");
						document.isform.check_on1[i].focus();
						break;
						*/
						}
			...
			/* $.ajax({
				   url:"/kcb/scd_step1.php",
				   dataType:"json",
                   type:"POST",
                   data:{"ap_name":$("#ap_name").val(),"ap_sex":$(':radio[name="ap_sex"]:checked').val(),"birthday":birthday,"handphone":handphone}, 
