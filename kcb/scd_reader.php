...
echo "<br>";
	...
	if($str_026_len > 0){
		@mysql_query( "delete from div_026 where savekey = '".$file_para[1]."'" );
		$column_026 = array();
...
echo "<br>";
    ...
    $i_103 = $rep_103;
    $sss1 = substr($b_str_div,$start_spot,$str_103);		   
	
	if(substr($sss1,0,1) != "]"){
         
	
	if($str_103_len > 0){
		@mysql_query( "delete from div_103 where savekey = '".$file_para[1]."'" );
		$column_103 = array();
