...
//$handphone = str_pad(trim($_REQUEST['ph21']),4, " ",STR_PAD_RIGHT).trim($_REQUEST['ph22']).trim($_REQUEST['ph23']);
$handphone = str_pad(substr($_REQUEST['handphone'],0,3),4, " ",STR_PAD_RIGHT).substr($_REQUEST['handphone'],3,11);
...
$ap_name = iconv("UTF-8","CP949",$_REQUEST['ap_name']);
$ip=$_SERVER['REMOTE_ADDR'];

echo $birthday.$handphone.$sex.$ap_name;
