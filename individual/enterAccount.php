			...
			<div class="row">
				...
				<div class="col-md-12 triggerAnimation animated" data-animate='fadeInUp'>
					...
					<div class="simple-heading mb-30">
						<h1>개인/계좌정보<span>개인정보 및 계좌정보를 확인 할 수 있습니다.</span></h1>
					</div><!-- .simple-heading end -->
					<ul class="breadcrumb">
						<li><a href="/index.php">Home</a></li>
						<li>MY 서비스</li>
						<li><span class="active">개인/계정정보 입력</span></li>
					</ul><!-- .breadcrumb end -->
				</div><!-- .col-md-12 end -->
			</div><!-- .row end -->
		</div><!-- .container end -->
		...
		<div class="container">
				...
				<div class="form-wrap form-type1">
					...
					<dl>
						...
						<dd><input type="text" placeholder="본인의 실명을 기입해주세요" /> 
							<span class="inblock"><input type="checkbox" /> 외국인</span>
						</dd>
					</dl>
					<dl>
			...
			<div class="box-cont2 mt-40">
				...
				<div class="form-wrap form-type1 ">
					...
					<span class="btn-area">
						<a class="btn btn-medium btn-centered btn-type2" href="#">
			...
			<div class="box-cont2 mt-40">
				...
				<div class="form-wrap form-type1">
					...
					<dl>
						<dt class="no_required">기존 비밀번호</dt>
						<dd><input type="password" placeholder="기존 비밀번호" /></dd>
					</dl>
					<dl>
						<dt class="no_required">비밀번호 변경</dt>
						<dd><input type="password" placeholder="새로운 비밀번호" /></dd>
					</dl>
					<dl>
						<dt class="no_required">비밀번호 확인</dt>
